...
public class UploadSessionRepository {
	...
	public UploadSession setUploadPath(String uploadId, String uploadPath, String chunkDir) {
		UploadSession uploadSession = getUploadSessionById(uploadId);
		uploadSession.setFilePath(uploadPath);
		uploadSession.setChunkDir(chunkDir);
		save(uploadSession);
		return uploadSession;
	}
